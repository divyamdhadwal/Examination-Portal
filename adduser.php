...
$totalusers=mysqli_query($connect,$sql);
  ...
  {
echo'<em><b>Current users and their passwords</b></em> 
<table>
<tr>
    <th>USERNAME</th>
    <th>PASSWORD</th>
...
ob_end_flush();
?>
<img src="content/images/newuser.png" align="center" width="160px" height="160px">
<form action="useradded.php" method="post">
<strong>USERNAME :</strong>
<input type="text" name="username" placeholder="Specify an username for the user" required><br>
<strong>PASSWORD :</strong>
<input type="password" class="input-generic" name="password" placeholder="Specify a password for the above username" required><br>
