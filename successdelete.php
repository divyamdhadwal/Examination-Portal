...
{
   $removebroadcast=$_POST["broadcastid"];
   $sql="DELETE  from mybroadcasts where id=$removebroadcast";
 if(mysqli_query($connect,$sql))
    {
        echo "Your announcement/broadcast has been successfully deleted !<br>";
        echo"<em>Redirecting you back to DELETE -> ANNOUNCEMENTS , Please wait...</em>";
        header("refresh:4;url=deletebroadcast.php");
    }
}
