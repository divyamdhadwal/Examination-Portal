...
<form method="post" action="addbroadcast.php">
<strong>BROADCAST :&nbsp;&nbsp;</strong>
    <input type="text" name="broad" placeholder="Write your new announcement here..."><br>
    <hr>
...
echo'</table>';
echo'<hr>';
echo'<b>INSTRUCTION BOX :</b>';
        
        echo"To make a new broadcast (no overwrite), use ID other than currently in use<br>";
        echo"If table is empty , Start from ID=1";
        mysqli_free_result($result);
    }
    else
    {
        echo"There is currently no announcement , you can start from ID=1";
    }
}
mysqli_close($connect);
    ...
    <input type="number" name="position" placeholder="Enter the position of broadcast"><br>
