...
<?php
echo"<b>FORMAT : USER ===> DATE TIME</b><br><em>Following records show user's/admin's LOGIN as well as LOGOUT time</em>";
$logfile=fopen("u89s54e67r6l899o45g121s.txt","r");
echo "<pre>".fread($logfile,"10000")."</pre>";
ob_end_flush();
?>
</div>
