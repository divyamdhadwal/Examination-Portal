...
<form action="databaseconnectpd1005.php" method="post">
<center>
<center>
<?php
...
<hr>
<center>
<strong>CURRENT QUESTIONS IN PD1005 for upcoming test :</strong>
<br>
</center>
<center> 
<?php
...
if($connect)
{
 $sql="SELECT questionnum,question,option1,option2,option3,option4,answer,marks from pd1005 ORDER BY questionnum";
