...
if($connect)
{
 $sql="SELECT registrationnum,name,dateofbirth,counter,marks from pd1006 ORDER BY registrationnum";
...
echo'<em><b><a href="saveresultspd1006.php">SAVE RESULTS</a></b></em>';
