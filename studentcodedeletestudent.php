...
<form action="deletestudentdatabasevalidator.php" method="post">    
<center>
    <b>SUBJECT CODE : </b>
    <input type="text" name="subcode" placeholder="PD1003 OR PD1004 OR PD1005 OR PD 1006"><br>
    <code>*Please make sure you type the correct subject code. </code><br>
    <hr>
