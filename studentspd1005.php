...
if($connect)
{
 $sql="SELECT registrationnum,name,dateofbirth,counter,marks from pd1005 ORDER BY registrationnum";
...
echo'<em><b><a href="saveresultspd1005.php">SAVE RESULTS</a></b></em>';
