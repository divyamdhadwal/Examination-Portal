...
if($connect)
{
$sql="INSERT into pd1004 values('$regnumber','$studentname','$dateofbirth','$counter','$marks')";
 if (mysqli_query($connect,$sql)) 
  {
  echo 'Defined student has been added to the database<br><em><a href="newstudentpd1004.php">Add another student</a></em>';
  }
 else
  {
  echo 'There was some error executing the query<br><em><a href="newstudentpd1004.php">Go back</a></em>';
  } 
}
else
{
    echo "Defined student has not been added because of some database error.<br>If error persists , please contact the administrator<br><em><a href='newstudentpd1004.php'>Go back</a></em>";
}
