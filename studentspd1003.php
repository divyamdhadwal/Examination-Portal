...
if($connect)
{
 $sql="SELECT registrationnum,name,dateofbirth,counter,marks from pd1003 ORDER BY registrationnum";
...
echo'<em><b><a href="saveresultspd1003.php">SAVE RESULTS</a></b></em>';
