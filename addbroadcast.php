...
{
   $mynewbroadcast=$_POST["broad"];
   $mynewposition=$_POST["position"];
    $sql="insert into mybroadcasts values('$mynewbroadcast','$mynewposition')";
 if(mysqli_query($connect,$sql))
    {
        echo "Your announcement/broadcast has been successfully added !<br>";
        echo"<em>Redirecting you back to CREATE NEW -> ANNOUNCEMENTS , Please wait...</em>";

        header("refresh:4;url=newbroadcast.php");
    }
}
