...
if($connect)
{
$asql="SELECT * from admindetails where username='$user' and password='$pass'";
...
if(mysqli_num_rows($aresult)>0)
...
else
  {
   ...
   if(mysqli_num_rows($uresult)>0)
    ...
    header("refresh:2;url=u78s56e89r31.php");
    echo'<center><img src="content/images/newloader.gif"></center>';
    echo '<p class="success">Login successful , please wait.<br>';
    }
    else
    ...
    echo '<p class="error">Wrong username/password entered';
     }
  }
}
else
