...
if($connect)
{
$sql="DELETE from pd1003 where registrationnum='$regnumber' and dateofbirth='$dateofbirth'";
 if (mysqli_query($connect,$sql)) 
  {
  echo 'Defined student has been deleted from the database<br><em><a href="deletestudentpd1003.php">Delete another student</a></em>';
  }
 else
  {
  echo 'There was some error executing the query<br><em><a href="deletestudentpd1003.php">Go back</a></em>';
  } 
}
else
{
    echo "Defined student has not been deleted because of some database error.<br>If error persists , please contact the administrator<br><em><a href='deletestudentpd1003.php'>Go back</a></em>";
}
