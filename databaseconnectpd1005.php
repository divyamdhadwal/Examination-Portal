...
$marks=$_POST["marks"];
$sql="INSERT into pd1005(questionnum,question,option1,option2,option3,option4,option5,answer,answertext,marks) values ('$questionnum','$question','$option1','$option2','$option3','$option4','$option5','$answer','$answertext','$marks')";
   if(mysqli_query($connect,$sql))
   {
   	
	echo"Question was added<br>";
	echo"<hr>";
	echo"<em> <a href='testcreatorpd1005.php'>Add another question</a></em>";
