...
if($connect)
{
$sql="SELECT username from admindetails";
$totaladmin=mysqli_query($connect,$sql);
  if(mysqli_num_rows($totaladmin)>0)
  {
echo'<em><b>Current administrators</b></em> 
<table>
<tr>
    <th>USERNAME</th>
</tr>';
   while($totadm=mysqli_fetch_assoc($totaladmin))
    {
echo'<tr>';    
            echo'<td>';       
            echo $totadm["username"];
            echo'</td>';
echo'</tr>';
    }
echo'</table>';
...
ob_end_flush();
?>
<img src="content/images/newadmin.png" align="center" width="160px" height="160px">
<form action="adminadded.php" method="post">
<strong>USERNAME :</strong>
<input type="text" name="username" placeholder="Specify an username for the admin" required><br>
<strong>PASSWORD :</strong>
<input type="password" class="input-generic" name="password" placeholder="Specify a password for the above admin" required><br>
