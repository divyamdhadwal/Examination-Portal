...
<form action="studentdeletedpd1003.php" method="post">
<center>
...
<hr>
<center>
<strong>CURRENT STUDENTS IN PD1003 for upcoming test :</strong>
<br>
<br>
</center>
<center> 
...
if($connect)
{
 $sql="SELECT registrationnum,name,dateofbirth,counter from pd1003";
