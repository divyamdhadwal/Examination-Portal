...
if($connect)
{
$sql="DELETE from userdetails where username='$username' and password='$password'";
if(mysqli_query($connect,$sql))
    {
        echo "Defined USER has been successfully <em><strong>deleted</em></strong> !<br>";
        echo"<em>Redirecting you back to DELETE -> USER , Please wait...</em>";
        header("refresh:4;url=deleteuser.php");
    }
    else
    {
