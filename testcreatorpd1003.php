...
<hr>
<b>TEST "ID" :</b>
<input type="text" name="testid" required><br>
<b>QUESTION NO:</b>
<input type="text" name="questionnum" required><br>
<b>QUESTION</b> :<br>
<textarea name="question" rows="13" cols="50" placeholder="Please write your question here..." style="margin: auto; width: 70%;" required></textarea>
</textarea><br>
<b>OPTIONS</b> :<br>
...
<input type="text" name="answer" class="input-generic" placeholder="1 OR 2 OR 3 OR 4 OR 5" required><br>
...
<hr>
<center>
<strong>CURRENT QUESTIONS IN PD1003 for upcoming test :</strong>
<br>
</center>
<center> 
<?php
...
if($connect)
{
 $sql="SELECT testid,questionnum,question,option1,option2,option3,option4,answer,marks from pd1003 ORDER BY questionnum";
