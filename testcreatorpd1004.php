...
<form action="databaseconnectpd1004.php" method="post">
<center>
<?php
...
<hr>
<center>
<strong>CURRENT QUESTIONS IN PD1004 for upcoming test :</strong>
<br>
</center>
<center> 
<?php
...
if($connect)
{
 $sql="SELECT questionnum,question,option1,option2,option3,option4,answer,marks from pd1004 ORDER BY questionnum";
